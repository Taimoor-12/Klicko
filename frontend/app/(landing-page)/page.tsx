      ...
      <main className="mt-12 md:mt-24">
        <section>
          <div className="flex flex-col items-center mt-12">
            ...
            <p className="mt-2 sm:mt-4 md:mt-6 text-sm sm:text-lg md:text-2xl text-center">
              Klicko turns your long, clunky URLs into clean, shareable links in
              seconds—making them easier to manage, track, and use across any
              platform without the usual mess.
            </p>
          </div>
          ...
          <div className="min-h-72 bg-muted rounded-4xl mt-12 mb-12 opacity-90">
            <Tabs defaultValue="shorten" className="w-full">
              <div className="flex justify-center mt-2">
                <TabsList>
                  <TabsTrigger
                    className="cursor-pointer text-sm md:text-base px-4 py-4 sm:px-6 sm:py-6 rounded-4xl mt-4 sm:mt-6 border-1 border-black"
                    value="shorten"
                  >
                    Short Link
                  </TabsTrigger>
              ...
              <TabsContent value="shorten" className="mx-6 mt-6">
                ...
                <div className="mt-15">
                  <LongUrlInput
                    ...
                    button={
                      <Button
                        className="mt-6 w-full h-12 md:w-64 cursor-pointer text-base md:text-lg md:px-6 mb-10"
